...
fn wire_address_address_from_script_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    network: impl CstDecode<crate::api::types::Network>,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco((move || {
                    crate::api::types::Address::address_from_script(
                        api_network,
                        api_script,
                        api_blinding_key,
                    )
...
fn wire_address_validate_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco((move || {
                    crate::api::types::Address::validate(api_address_string)
                })())
            }
        },
    )
